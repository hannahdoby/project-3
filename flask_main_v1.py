...
@app.route('/')
def hotel():
    return [nyc_h(),la_h(),phx_h(),cho_h(),santo_h(),sandi_h(),dalla_h(),phila_h(),houston_h(),austin_h()]

@app.route('/food')
def food():
    return [nyc_f(),la_f(),phx_f(),cho_f(),santo_f(),sandi_f(),dalla_f(),phila_f(),houston_f(),austin_f()]
